   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":2D53
            Left            =   1530
            List            =   "frmPrefs.frx":2D55
            Style           =   2  'Dropdown List
            TabIndex        =   56
...
'    gblPlhLocationPercPrefValue
    ...
    If gblPlStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "IOMarbleWidget", """" & App.Path & "\" & "IO.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "IOMarbleWidget", vbNullString)
    End If
...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/IO-VB6-Widget", vbNullString, App.Path, 1)
    End If
End Sub
...
loadHigherResPrefsImages_Error:
    ...
    MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure loadHigherResPrefsImagesof Form planetPrefs"
End Sub
'---------------------------------------------------------------------------------------
