...
Public Sub mnuLatest_Click()
    ...
    If answer = vbYes Then
        Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/IO-VB6-Widget/raw/main/Setup.exe", vbNullString, App.Path, 1)
    End If
